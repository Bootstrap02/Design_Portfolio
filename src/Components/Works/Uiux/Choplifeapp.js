...
import Appmockup from './Foodappmockup'

const Choplifeapp = () => {
  const background = {
    backgroundImage :  `url(${Images.foodapp.mockBG})`,
  ...
  return (
    ...
    <img src={Images.foodapp.heart} width={80} height={80} loading='lazy'/>
