...
import Webmockup from './Foodwebmockup'
...
const Choplifeweb = () => {
  ...
  return (
    <div className='bg-white w-[100%]  max-lg:flex max-lg:flex-col'>
      ...
      <h1>Welcome to <span className=' text-4xl text-[#80214C]'>Choplife </span> food delivery website</h1>
      </div>
       <div>
        <img src={Images.foodweb.mock1}/>
       </div>
       <div>
       ...
       <div className='flex justify-center'>
        <img className='w-[90%]' src={Images.foodweb.mockgroup} loading='lazy'/>
       </div>
        </div>
        ...
        <div className='flex justify-center'><p className='text-xl w-[80%]'>A brand guideline, also known as a brand-style-guide or brand book is a documentthat outlines the visual and verbal guidelines for maintaining consistency and coherence in a brand's identity.</p></div>
          <div className= ' bg-[#f7f6f6] shadow-lg p-6 my-6 mx-8 rounded-lg '>
           <img src = {Images.foodweb.Colortexts} loading ='lazy'/>
          </div>
        </div>
       </div>
       ...
       <div className='text-4xl text-center font-bold p-6'><span className='text-[#80214C]'>Wireframe </span>Design</div>
        <div className='m-8 p-8 max-lg:m-2 max-lg:p-2 bg-[#f7f6f6] shadow-lg rounded-lg'>
          <video src= {Images.foodweb.intro} width="100%" height="auto" controls autoPlay/>
        </div>
